...
export default function GroupExpensesPage() {
  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="container mx-auto py-6 max-w-4xl relative z-[100] mt-20 px-4">
        <div className="mb-6">
          <Button
            variant="outline"
            size="sm"
        ...
        <Tabs
          ...
          className="space-y-4 relative z-[100] mt-4"
        >
          ...
          <TabsContent value="expenses" className="space-y-4" key={`expenses-${expenses.length}`}>
            <ExpenseList
              expenses={expenses}
          ...
          <TabsContent value="settlements" className="space-y-4" key={`settlements-${settlements.length}`}>
            <SettlementList
